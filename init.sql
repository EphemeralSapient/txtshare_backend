...
CREATE TABLE file_data (
  ...
  created TIMESTAMPTZ  NOT NULL DEFAULT NOW(), -- Version timestamp 
  expire TIMESTAMPTZ  NOT NULL, -- Expire deadline
...
CREATE TABLE url_lookup (
    ...
    expire TIMESTAMPTZ  NOT NULL,  -- Updates according with latest file data
    pass VARCHAR(64), -- Can be null, if not password protected
